                    ...
                    <?php
                        ...
                        if ($existingMatch !== false) {
                            if ($existingMatch['status'] == 2) {
                               ...
                               echo "<button class='aceptarmatch' onclick='aceptarmatch($id1, $id2, $id3, $id4)' " . (($existingMatch['status'] == 1) ? '' : 'disabled') . ">Match</button>"; // acepta el match
                                echo "<button class='rechazo' onclick='rechazo($id1, $id2, $id3, $id4)' " . (($existingMatch['status'] == 1) ? '' : 'disabled') . ">Rechazar</button>"; // rechaza
                               echo "<button class='aceptaramistad' onclick='aceptaramistad($id1, $id2, $id3, $id4)' " . (($existingMatch['status'] == 1) ? '' : 'disabled') . ">Amistad</button>"; // acepta el match
                            }
                        } else {
