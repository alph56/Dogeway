...
<head>
    ...
    <title>Actualización de Mascotas</title> 
</head>
<body>
    <nav class="nav">
        <div class=ranalogo>
        ...
        <div class="edicion">
            ...
            <h2 class="titulo-edit">Edición de perfil mascota</h2> 
            ...
            ?>
            <?php
                require 'visualizacion-main.php';
                $conexion = conectar();
                ...
                while($consultapets = mysqli_fetch_array($allpets)){
                    if($consultapets['id_usuario']){
                        if($consultapets['categoria'] == 1){$Categoria = 'Match';}
            ...
            ?>
                    <form action="update-pet.php" method="post">
                        ...
                        <p>Descripción: </p>
                        <input type="text" name="descripición" value="<?php echo $consultapets['descripcion'];?>" required placeholder="Edad (En años)"><br><br>
                        <p>Edad: </p>
